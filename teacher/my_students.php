...
if (!isset($_SESSION['teacher_id'])) {
    header("Location: ../login.php?error=" . urlencode("Please log in as a teacher."));
    exit();
}
                        ...
                        <?php if (count($students) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">
                                    <button type="button" class="btn btn-detail" onclick="viewDetails(<?php echo htmlspecialchars(json_encode($student)); ?>)">

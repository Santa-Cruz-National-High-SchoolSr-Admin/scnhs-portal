...
<style>
    ...
    @media print {
        .report-header { background: #f0f4ff !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
<main class="main-content">
    <header class="header">
        ...
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <button type="button" onclick="window.print()" class="btn btn-primary" style="padding:8px 18px;font-size:0.85rem">
